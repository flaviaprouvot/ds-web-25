...
//Validar se a array cliente contem dados
    if (!isset($data['cliente'])) {
        throw new Exception("Estrutura de dados inválida: campo 'cliente' ausente");
    }

//Validar se a array venda contem dados
